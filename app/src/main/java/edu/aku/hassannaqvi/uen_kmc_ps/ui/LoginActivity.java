...
import static edu.aku.hassannaqvi.uen_kmc_ps.core.MainApp.editor;
import static edu.aku.hassannaqvi.uen_kmc_ps.core.MainApp.sharedPref;
import static edu.aku.hassannaqvi.uen_kmc_ps.database.CreateTable.DATABASE_COPY;
...
import edu.aku.hassannaqvi.uen_kmc_ps.core.AppInfo;
import edu.aku.hassannaqvi.uen_kmc_ps.core.MainApp;
import edu.aku.hassannaqvi.uen_kmc_ps.database.DatabaseHelper;
import edu.aku.hassannaqvi.uen_kmc_ps.databinding.ActivityLoginBinding;
...
public class LoginActivity extends AppCompatActivity {
    ...
    public void onSyncDataClick(View view) {
        ...
        if (networkInfo != null && networkInfo.isConnected()) {
            startActivity(new Intent(this, edu.aku.hassannaqvi.uen_kmc_ps.ui.SyncActivity.class).putExtra("login", true));
        } else {
    ...
    public void attemptLogin(View view) {
        ...
        if (attemptCounter == 7) {
            ...
            if ((username.equals("dmu@aku") && password.equals("aku?dmu"))
                ...
                Toast.makeText(edu.aku.hassannaqvi.uen_kmc_ps.ui.LoginActivity.this, username + " " + password, Toast.LENGTH_SHORT).show();
            }
