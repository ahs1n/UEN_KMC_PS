package edu.aku.hassannaqvi.uen_kmc_ps.ui;

import static edu.aku.hassannaqvi.uen_kmc_ps.core.MainApp.PROJECT_NAME;
import static edu.aku.hassannaqvi.uen_kmc_ps.core.MainApp.sdDir;
import static edu.aku.hassannaqvi.uen_kmc_ps.core.MainApp.uploadData;
import static edu.aku.hassannaqvi.uen_kmc_ps.utils.AndroidUtilityKt.isNetworkConnected;
...
import edu.aku.hassannaqvi.uen_kmc_ps.adapters.SyncListAdapter;
import edu.aku.hassannaqvi.uen_kmc_ps.contracts.TableContracts.HouseholdTable;
import edu.aku.hassannaqvi.uen_kmc_ps.contracts.TableContracts.MWRATable;
import edu.aku.hassannaqvi.uen_kmc_ps.contracts.TableContracts.TableVillage;
import edu.aku.hassannaqvi.uen_kmc_ps.contracts.TableContracts.UsersTable;
import edu.aku.hassannaqvi.uen_kmc_ps.contracts.TableContracts.VersionTable;
import edu.aku.hassannaqvi.uen_kmc_ps.core.MainApp;
import edu.aku.hassannaqvi.uen_kmc_ps.database.DatabaseHelper;
import edu.aku.hassannaqvi.uen_kmc_ps.databinding.ActivitySyncBinding;
import edu.aku.hassannaqvi.uen_kmc_ps.models.SyncModel;
import edu.aku.hassannaqvi.uen_kmc_ps.workers.DataDownWorkerALL;
import edu.aku.hassannaqvi.uen_kmc_ps.workers.DataUpWorkerALL;
import edu.aku.hassannaqvi.uen_kmc_ps.workers.PhotoUploadWorker2;
import edu.aku.hassannaqvi.uen_kmc_ps.workers.ReadJSONWorker;
        ...
        if (sdDir.exists()) {
            ...
            if (files.length > 0) {
                ...
                for (int i = 0; i < fcount; i++) {
                    TextView textView = new TextView(edu.aku.hassannaqvi.uen_kmc_ps.ui.SyncActivity.this);
                    ...
                    handler.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            WorkManager.getInstance(SyncActivity.this).getWorkInfoByIdLiveData(photoUpload.getId())
                                    .observe(edu.aku.hassannaqvi.uen_kmc_ps.ui.SyncActivity.this, new Observer<WorkInfo>() {
                                        ...
                                        public void onChanged(@Nullable WorkInfo workInfo) {
                                            ...
                                            if (workInfo.getState() == WorkInfo.State.FAILED) {
                                                Toast.makeText(edu.aku.hassannaqvi.uen_kmc_ps.ui.SyncActivity.this, "Failed", Toast.LENGTH_SHORT).show();
