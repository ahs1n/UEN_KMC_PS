package edu.aku.hassannaqvi.uen_kmc_ps.ui.sections;

import static edu.aku.hassannaqvi.uen_kmc_ps.core.MainApp.households;
...
import edu.aku.hassannaqvi.uen_kmc_ps.databinding.ActivitySectionABinding;
import edu.aku.hassannaqvi.uen_kmc_ps.ui.EndingActivity;
import edu.aku.hassannaqvi.uen_kmc_ps.ui.lists.MwraActivity;
...
*/
    ...
    private boolean formValidation() {
        ...
        if (bi.ra2001.isChecked() && Integer.parseInt(bi.ra18.getText().toString()) > Integer.parseInt(bi.ra17C2.getText().toString())) {
